...
def seed() -> None:
    ...
    try:
        ...
        cliente_a = Customer(nombre="Cliente A", rut="76111111-1", ciudad="Santiago", tipo_cliente="empresa")
        cliente_b = Customer(nombre="Cliente B", rut="76222222-2", ciudad="Antofagasta", tipo_cliente="empresa")
        ...
        maquina_33 = Machine(numero_interno="33", marca="Toyota", modelo="8FG25", tipo="forklift", estado="operativa")
        maquina_42 = Machine(numero_interno="42", marca="Hyster", modelo="H2.5FT", tipo="forklift", estado="operativa")
        ...
        db.commit()
        print("Datos de desarrollo creados: 4 usuarios, 3 clientes, 3 máquinas.")
    finally:
        db.close()
